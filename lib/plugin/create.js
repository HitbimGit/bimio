  ...
  .then(() => {
    ...
    bim.app.template({
      ...
      if (compiled.error) alert(compiled.message, document.title);
        ...
        bim.app.appendHTML(".app-content", compiled.template);
      }
    }).then(() => {
...
<html>
  <head>
    ...
    <script 
      ...
      src="https://cdn.hitbim.com/v/3.0.0/sdk/bim.sdk.min.js"
    ></script>
    </head>
    <body>	
    <div class="views">
...
`;
  ...
  fs.writeFileSync(path.join(pluginPath, `index.html`), indexHtmlData, "utf8");
};
