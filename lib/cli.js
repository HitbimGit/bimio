...
program
  ...
  .option("-da, --debug-all", "Output all debug info")
...
// If options both debug-server & debug-error ..
if (program.opts().debugServer && program.opts().debugError) {
  // Enable debug server and error
  comm.logWithColor(chalk.yellowBright, "Debug Server and Error Enabled ...\n");
  debug.enable("server,error");
} else if (program.opts().debugServer) {
  // Enable debug server
  comm.logWithColor(chalk.yellowBright, "Debug Server Enabled ...\n");
  debug.enable("server");
} else if (program.opts().debugError) {
  // Enable debug error
...
// If option debug-all
if (program.opts().debugAll) {
  // Enable all debug
  comm.logWithColor(chalk.yellowBright, "Debug All Enabled ...\n");
  debug.enable("*");
}
